...
TARGET_TARBALL_PATH		= $(CACHE_PATH)/$(TARGET_TARBALL_NAME)
TARGET_URL			= https://github.com/downloads/$(TARGET_NAME)/$(TARGET_NAME)/$(TARGET_TARBALL_NAME)
...
$(TARGET_TARBALL_PATH):
	curl --location --output $(TARGET_TARBALL_PATH) $(TARGET_URL)
